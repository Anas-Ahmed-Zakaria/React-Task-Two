...
export default function Navbars() {
  const { counterTest } = useContext(CounterContext);

  return (
    <Navbar expand="lg" className="bg-body-tertiary bg-dark">
      <Container className='d-flex justify-content-between'>
        <Navbar.Brand href="#">Navbar</Navbar.Brand>
        <Navbar.Brand href="#" className='text-light d-flex align-items-center gap-1'>
        ...
        <div className='counter__increase'>{counterTest}</div>
        </Navbar.Brand>
      </Container>
    </Navbar>
  );
